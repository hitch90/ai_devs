...
class QdrantClient {
     ...
     */
    async recommend(collection_name, { positive, negative, strategy, filter, params, limit = 10, offset = 0, with_payload = true, with_vector = false, score_threshold, using, lookup_from, consistency, }) {
     ...
     * @returns Operation result
     */
    async recommendPointGroups(collection_name, { consistency, positive, strategy, negative = [], filter, params, with_payload = null, with_vector = null, score_threshold, using = null, lookup_from = null, group_by, group_size, limit, }) {
