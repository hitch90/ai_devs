...
export declare class QdrantClient {
     ...
     */
    recommend(collection_name: string, { positive, negative, strategy, filter, params, limit, offset, with_payload, with_vector, score_threshold, using, lookup_from, consistency, }: Omit<SchemaFor<'RecommendRequest'>, 'limit'> & Partial<Pick<SchemaFor<'RecommendRequest'>, 'limit'>> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        id: string | number;
        version: number;
     ...
     * @returns Operation result
     */
    recommendPointGroups(collection_name: string, { consistency, positive, strategy, negative, filter, params, with_payload, with_vector, score_threshold, using, lookup_from, group_by, group_size, limit, }: {
        consistency?: SchemaFor<'ReadConsistency'>;
